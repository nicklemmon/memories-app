...
class FormEditMemory extends React.Component {
  ...
  render() {
    const { rawId, id, editSuccessCallback, editFailureCallback } = this.props
    const { title, date, summary, modalIsOpen } = this.state
    ...
    return (
      <ModalLauncher
        ...
        primaryButtonOnClick={() =>
          this.handleSubmit(rawId, editSuccessCallback, editFailureCallback)
        }
        primaryButtonCloses
